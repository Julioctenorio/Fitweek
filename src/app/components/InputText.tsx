    ...
    <>
      <label htmlFor={id} className="relative w-80 h-15 mb-4 "> 
        <input
          ...
          id={id}
          placeholder=""
          className="peer m-0.5 w-full h-12 pl-4 rounded-lg text-white bg-neutral-800 border-gray-300 shadow-sm sm:text-sm no-spinners dark:border-gray-600 dark:bg-neutral-800 dark:text-white"
          value={value}
          onChange={onChange}
          required={required}
          autoComplete="off"
